...
// Avoid expensive string allocations (.split('\n')) and DOM rebuilds on every keystroke.
// Count newlines via character loop and return early if line count hasn't changed.
