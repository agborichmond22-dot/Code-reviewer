...
// Persist API key securely on change
...
async function analyze() {
  ...
  try {
    ...
    if (!apiKey) {
      ...
      throw new Error('Anthropic API key is missing. Please enter your API key in the header input.');
    }
