...
async function analyze() {
  ...
  try {
    const apiKey = (apiKeyEl ? apiKeyEl.value.trim() : '') || localStorage.getItem('anthropic_api_key') || '';
    if (!apiKey) {
      throw new Error('Anthropic API Key is required. Please enter your key in the top-right header input.');
    }
