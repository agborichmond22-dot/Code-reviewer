...
async function analyze() {
  ...
  try {
    const apiKey = localStorage.getItem('anthropic_api_key') || (apiKeyEl ? apiKeyEl.value.trim() : '');
    if (!apiKey) {
      throw new Error('Please enter your Anthropic API Key in the top header first.');
    }
