...
async function analyze() {
  ...
  if (!apiKey) {
    showError('Please enter your Anthropic API Key in the input field in the header.');
    return;
  }
...
// Load saved API key on startup and persist on input changes
if (apiKeyEl) {
  ...
  // Persist API key on input change safely
