...
// ── LINE NUMBERS ───────────────────────────────────
// OPTIMIZATION: Avoid O(N) array allocation (.split('\n')) and expensive
// DOM layout thrashing/gutter updates on every keystroke. We check parameter
// strictly (force === true) to prevent browser-implicit Event override.
function updateGutter(force) {
  ...
  // If line count hasn't changed and we aren't forcing, early return O(1)
